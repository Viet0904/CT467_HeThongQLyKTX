...
<nav class="navbar navbar-expand-lg navbar-light bg-light py-1"
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center position-relative me-3">
            ...
            <span class="me-2 ms-2" id="userDropdown" style="cursor: pointer;" onclick="toggleDropdown(event)">Sinh Viên</span>
            ...
            <div id="dropdownMenu" class="dropdown-menu position-absolute p-0 ms-1" style="display: none;">
                <a class="dropdown-item py-2" href="./user_profile.php">Thông tin</a>
                <!-- Đường phân cách -->
