                        ...
                        <form action="add_day.php" method="POST">
                            ...
                            <div class="row row-add mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="MaDay" name="MaDay" required value="">
                                </div>
                                <div class="col-md-4">

                                    <label for="TenDay" class="form-label">Tên Dãy</label>

                                    <input type="text" class="form-control" id="TenDay" name="TenDay" required value="">
