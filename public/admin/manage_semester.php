...
// Đếm tổng số dòng
$totalRowsQuery = "SELECT COUNT(*) FROM HocKi";
                ...
                <div class=" mt-4"
                    ...
                    <div class="container-fluid py-3 px-2" style="padding: 20px;">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="./add_hocki.php" class="btn text-white"
                                style="background-color: rgb(219, 48, 119);">
                                <i class="fas fa-plus me-1"></i>Thêm học kì
                            </a>
                        </div>
                        <?php
                        ...
                        if (count($areas) > 0) {
                            ...
                            foreach ($semesters as $semester) {
                                ...
                                echo '<tr>';
                                echo '<td>' . $stt++ . '</td>';
                                echo '<td>' . htmlspecialchars($semester["HocKi"]) . '</td>';
                                echo '<td>' . htmlspecialchars($semester["NamHoc"]) . '</td>';
                                echo '<td>' . htmlspecialchars($semester["BatDau"]) . '</td>';
                                echo '<td>' . htmlspecialchars($semester["KetThuc"]) . '</td>';
                                echo '<td>
