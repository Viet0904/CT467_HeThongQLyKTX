                            ...
                            <tbody>
                                <?php foreach ($terms as $term): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="manage_hocki.php?id=<?php echo htmlspecialchars($term['HocKi']); ?>" class="btn btn-primary btn-sm">Sửa</a>
                                            <a href="delete_hocki.php?id=<?php echo htmlspecialchars($term['HocKi']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xoá học kỳ này?');">Xóa</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
