...
if (isset($_POST['MaKhuKTX']) && isset($_POST['TenKhuKTX'])) {
    ...
    try {
        $stmt = $dbh->prepare("CALL ThemKhuKTX(:maKhu, :tenKhu, @message, @errorCode)");
        $stmt->execute([
            ':maKhu' => $maKhu,
            ':tenKhu' => $tenKhu,
        ]);
            ...
            <div class="col px-0">
                <div class="my-2" style="margin-left: 260px;">
                    ...
                    <div class="modal-user mt-3">
                        <form action="add_khu.php" method="POST">

                            <div class="row row-add mb-3">
                                <div class="col-md-6">
                                    <label for="MaKhuKTX" class="form-label">Mã Khu</label>

                                    <input type="text" class="form-control" id="MaKhuKTX" name="MaKhuKTX" required value="">
                                </div>
                                <div class="col-md-6">

                                    <label for="maPhong" class="form-label">Tên Khu</label>

                                    <input type="text" class="form-control" id="TenKhuKTX" name="TenKhuKTX" required value="">
